...
def menu():
    ...
    ok, msg = inventario.cargar_desde_archivo()
    if ok:
        print("✅", msg)
    else:
        print("❌", msg)
    ...
    while True:
        ...
        if opcion == "1":
            ...
            ok, msg = inventario.eliminar_por_id(id_producto)
            print(("✅" if ok else "❌"), msg)
            ...
            ok, msg = inventario.actualizar_por_id(id_producto, nueva_cantidad, nuevo_precio)
            print(("✅" if ok else "❌"), msg)
            ...
            print("\n👋 Saliendo del sistema. Inventario guardado. ¡Buen trabajo!")
            break
